        ...
        <div class="bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto">
          ...
          <form action="{{ route('user.store') }}" method="POST" class="space-y-5">
            ...
            <div>
              ...
              <input type="text" name="password" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
              <label class="block mb-1 font-medium text-gray-700">Username</label></label>
              <input type="text" name="username" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
              <label class="block mb-1 font-medium text-gray-700">Level</label>
              <input type="text" name="level" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="pt-4">
